...
public class PopulaDados {
        ...
        public void cadrastro() throws ParseException {
                ...
                Servico srv1 = new Servico(null, sDateFormat.parse("02/09/2021 09:00"),
                                sDateFormat.parse("02/09/2021 12:00"), "Tosa", clt1, fnc1, pet1);
                Servico srv2 = new Servico(null, sDateFormat.parse("03/09/2021 12:00"),
                                sDateFormat.parse("04/09/2021 12:00"), "Hotel", clt1, fnc1, pet2);
                Servico srv3 = new Servico(null, sDateFormat.parse("05/09/2021 16:00"),
                                sDateFormat.parse("05/09/2021 16:30"), "Vermifugação", clt1, fnc1, pet3);
